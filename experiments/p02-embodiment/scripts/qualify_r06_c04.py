...
def main() -> int:
    ...
    result = {
        ...
        "status": "PASS" if left_plan["directional_progress"] and right_plan["directional_progress"] else "BLOCKED",
        ...
        "stop_reason": "corrected runtime transform and persistent leg correspondence still yield opposite touchdown progression for both directions" if not (left_plan["directional_progress"] and right_plan["directional_progress"]) else None,
    }
