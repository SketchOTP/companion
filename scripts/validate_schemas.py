...
for name in NAMES:
    ...
    try:
        ...
        valid = sample(schema)
        if name in {"mon-animation-clip.schema.json", "mon-animation-track.schema.json", "mon-temporal-track-v2.schema.json", "mon-authored-frame-pack-v1.schema.json", "mon-authored-frame-source-pack-v1.schema.json", "mon-ingested-frame-pack-v1.schema.json", "mon-frame-intake-receipt-v1.schema.json", "mon-opaque-black-frame-source-pack-v1.schema.json", "mon-locomotion-intent-v1.schema.json", "mon-locomotion-intent-v2.schema.json"}:
