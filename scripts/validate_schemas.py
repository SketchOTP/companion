...
for name in NAMES:
    ...
    try:
        ...
        valid = sample(schema)
        if name in {"mon-animation-clip.schema.json", "mon-animation-track.schema.json", "mon-temporal-track-v2.schema.json", "mon-authored-frame-pack-v1.schema.json", "mon-authored-frame-source-pack-v1.schema.json", "mon-ingested-frame-pack-v1.schema.json", "mon-frame-intake-receipt-v1.schema.json", "mon-opaque-black-frame-source-pack-v1.schema.json"}:
            fixture_name = {"mon-animation-clip.schema.json": "mon-animation-clip-v1.json", "mon-animation-track.schema.json": "mon-animation-track-v1.json", "mon-temporal-track-v2.schema.json": "mon-temporal-track-v2.json", "mon-authored-frame-pack-v1.schema.json": "mon-authored-frame-pack-v1.json", "mon-authored-frame-source-pack-v1.schema.json": "mon-authored-frame-source-pack-v1.json", "mon-ingested-frame-pack-v1.schema.json": "mon-ingested-frame-pack-v1.json", "mon-frame-intake-receipt-v1.schema.json": "mon-authored-frame-intake-receipt-v1.json", "mon-opaque-black-frame-source-pack-v1.schema.json": "mon-opaque-black-frame-source-pack-v1.json"}[name]
