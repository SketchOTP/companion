...
Status: `CORRECTED — SEMANTIC CROSSWALK VALIDATED FOR REVIEW`
...
- **S17:** [RFC 8785 JSON Canonicalization Scheme](https://www.rfc-editor.org/rfc/rfc8785.html) — invariant UTF-8 JSON representation, I-JSON input, deterministic property ordering, Unicode preservation, and invalid numeric rejection for repeatable hashes/signatures.
- **S18:** [systemd journal monotonic cutoff semantics](https://www.freedesktop.org/software/systemd/man/sd_journal_get_cutoff_realtime_usec.html) — monotonic time begins anew on reboot and is well-defined across journal records only with a boot identifier.
- **S19:** [SQLite release news](https://sqlite.org/news.html) — 3.52.0 withdrawal and later 3.53-series publication invalidate a loose `3.51.3+` eligibility rule; no exact build is preselected.
- **S20:** [Python 3.12 documentation](https://docs.python.org/3.12/), [Rust installation/toolchain documentation](https://www.rust-lang.org/tools/install/), and [Go documentation](https://go.dev/doc/) — official candidate/toolchain entry points only; target-host evidence and rights records, not documentation, decide EXP-00.
...
|---|---|---|---|---|
| **Persistent individual** | companion-core single writer; append-only JCS-canonical events and deterministic projections; milestone restart/replay/restore | ADR-04 **Use a hybrid persistent-organism architecture as the working direction — Interim**; ADR-05 **Do not allow a language model to own canonical identity, state, memory, or safety authority — Interim**; ADR-08 **Use append-only evidence with typed, temporal, versioned derived memories — Interim**; ADR-14 **Require local survival and owner-portable creature continuity — Interim** | RISK-05 **False or corrupted autobiographical memory**; RISK-08 **Cloud, subscription, vendor, model, or service shutdown**; RQ-09/RQ-11 open | Local ext4/NVMe available; SSHFS excluded. S02–S04, S17–S19. |
...
| **Caregiving utility** | separate care-core; direct authenticated producer→care path; care-owned safety-input receipts; deterministic named policy; synthetic shadow-help milestone | ADR-03 **Keep the caregiving safety core architecturally independent from the companion — Adopted**; ADR-15 **Qualify named safety scenarios instead of building a generalized danger detector — Adopted**; ADR-35 **Use explicit spoken help request as the first caregiving scenario in Kentucky, United States — Adopted** | RISK-01 **Missed qualified emergency or distress event**; RISK-02 **False safety escalation and alarm fatigue**; RISK-13 **Check-in interaction is inaccessible to a user in distress or with disability**; RQ-08/RQ-10 open | Audio capability only metadata; S09–S11, S17–S18; EXP-08; live delivery prohibited. |
| **Privacy and security** | trust zones, one-writer stores, no default network, ephemeral media, explicit identity-consent-vault, consumer-rights seams | ADR-03/05/11/12/14/34 Adopted or Interim as stated; ADR-33 adult/single-owner Adopted | RISK-03; RISK-04 **Private camera, microphone, memory, or safety data exposure**; RISK-07; RISK-09 **Code, model, dataset, voice, asset, or plugin rights are incompatible**; RQ-07/RQ-09/RQ-10 | S02, S05–S10, S12–S14, S17. |
...
|---|---|---|
| **Phase 00 — Planning and product contract** | Options, recommendation, boundaries, RQ dispositions, distinct Phase 01 foundation and cross-phase milestone contracts, experiment/dependency/release plan | ADR-31/32 Adopted; RISK-12; all remaining RQs |
| **Phase 01 — Environment and engineering foundation** | Reproducible repository/process shells, typed/canonical IPC, XDG, logging/health, supervision, deterministic controls, CI/provenance foundation; EXP-00 blocks core/care/vault implementation only | ADR-18 Adopted, ADR-21 Interim, ADR-22/23 Adopted, ADR-24 Interim; RISK-09/10/12/14; S17–S20 |
...
| **Phase 04 — Evidence, world model, and persistent memory** | evidence-before-belief, JCS-canonical typed events/projections, reboot-aware sequence/causation, exact-build SQLite candidate tests | ADR-05/08/11 Interim; RISK-05; RQ-09; S03/S04/S17–S19 |
...
| **Phase 06 — Vision, identity, and social attention** | sensor gateway plus explicit identity-consent-vault boundary, unknown identity, opaque biometric handles, no biometric milestone functionality | ADR-11 Interim, ADR-12 Adopted; RISK-03/04/07; RQ-07 |
...
| **Phase 10 — Caretaking core foundation** | independent care process/store; direct authorized safety ingress; care-owned receipt/incident journals; signed deterministic policy; shadow-only milestone proof | ADR-03/15/35 Adopted; RISK-01/02/13; RQ-08/RQ-10 |
| **Phase 11 — Security, privacy, resilience, and owner continuity** | trust zones, explicit vault authority, canonical event/digest/time rules, rights/BOM, update/migration/backup/restore, egress deny | ADR-14 Interim, ADR-34 Adopted; RISK-03/04/07/08/09/14; RQ-09/11; S17–S19 |
...
The remembered-interaction plus shadow-help architecture proof is not the Phase 01 contract. It is a later milestone drawing bounded work from Phases 02, 03, 04, and 10 after Phase 01 and all named prerequisites pass. Passing it does not complete any contributing phase; its early care work exists only to retire the safety-authority coupling risk before broad feature development.
...
- S01–S20 are current primary sources. They support standards/platform/legal/toolchain design constraints, not runtime capability, dependency approval, benchmark results, or legal conclusions.
- Direct safety ingress, the vault owner, canonical bytes/time, phase separation, EXP-00, exact SQLite eligibility, and evidence-floor semantics were manually checked across every affected artifact after Architect Review 01.
