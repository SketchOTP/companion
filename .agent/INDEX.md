...
- Active coder directive: `COMPANION-P00-QUAL-001 — FINAL EVIDENCE HARDENING REQUIRED`
...
- Current correction authority: `.agent/tasks/active/COMPANION-P00-QUAL-001/ARCHITECT_REVIEW_02.md`
...
2. Fetch current `origin/main` and the existing `codex/p00-qual-001` branch. Do not reset, rebase, or force-push published work.
3. Continue only in the clean local-ext4/NVMe secondary worktree and existing PR #5.
...
5. Read `.agent/tasks/active/COMPANION-P00-QUAL-001/ARCHITECT_REVIEW_02.md` in full.
6. Fetch the live Notion Architect Review 02, parent directive, coder report, canonical project, roadmap, ADR ledger, Evidence Register, PR #5, and Issue #4 with all comments.
7. Preserve accepted Godot/systemd evidence and prior failed attempts. Do not create busywork by repeating unchanged work.
8. Add committed sanitized machine-readable results and exact provenance plus an assertion-driven fail-closed validator.
9. Correct IPC supervisor endpoint/secret ownership, add assertions, and retain the bounded threat ceiling.
...
- Corrected real-process IPC observations: retained as bounded candidate evidence; mechanism not adopted.
- Oracle/profile and Python/Rust measurements: retained as provisional evidence; language not selected.
- SQLite corrected observations: retained as bounded candidate evidence; database not adopted.
